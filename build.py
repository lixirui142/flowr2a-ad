...
<section class="section" id="qualitative">
  ...
  <p class="section-desc">
    Side-by-side comparisons of FlowR2A against DiffusionDrive, DiffusionDriveV2, and iPad on NAVSIM navtest.
    We show <em>all</em> proposals generated by each planner, colored by PDMS from
    0 (<span class="pdms-red">red</span>) to 1 (<span class="pdms-green">green</span>).
  </p>
</section>
"""

# The supplementary <main> already contains the gallery <section>s; insert directly.
QUALITATIVE = f'<main>{qual}</main>'
...
<section class="section" id="experiments">
  ...
  <p class="section-desc">Additional analyses: top-K proposal quality and interactive controllable sampling.</p>

  <h3 style="margin:18px 0 8px;font-size:17px;color:var(--accent)">Top-K proposal quality</h3>
  ...
  <h3 style="margin:18px 0 8px;font-size:17px;color:var(--accent)">Interactive sampling space</h3>
  <div class="exp-card exp-full">
...
out = HEAD + HERO + QUALITATIVE_HEADER + QUALITATIVE + FRAMEWORK + EXPERIMENTS + BIBTEX + FOOTER
